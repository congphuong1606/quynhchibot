...
function updateGroupSheet(idChat, title, msg) {
    ...
    const url23 = baseUrl + "/exec?action=insert-sheet_bot3&sheet_name=" + idChat + "&user_id=" + userId + "&user_full_name=" + fullName + "&user_name=" + userName + "&is_bot=" + isbot + "&title=" + title;
